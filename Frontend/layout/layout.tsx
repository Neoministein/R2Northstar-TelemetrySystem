...
const Layout = (props) => {
    ...
    return (
        <React.Fragment>
            <Head>
                <title>Global R2Northstar Telemetry</title>
                <meta charSet="UTF-8" />
                <meta name="description" content="A website for viewing global telemetry for R2Northstar" />
                <meta name="robots" content="index, follow" />
                <meta name="viewport" content="initial-scale=1, width=device-width" />
                <meta property="og:type" content="website"></meta>
                <meta property="og:title" content="Global R2Northstar Telemetry"></meta>
                <meta property="og:description" content="A website for viewing global telemetry for R2Northstar" />
