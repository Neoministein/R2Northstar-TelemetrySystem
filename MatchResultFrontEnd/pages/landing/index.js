                ...
                <div className="py-4 px-4 mx-0 md:mx-6 lg:mx-8 lg:px-8 flex align-items-center justify-content-between relative lg:static">
                    <Link href="/">
                        <a className="flex align-items-center">
                            <img src={`${contextPath}/layout/images/logo-dark.svg`} alt="Sakai Logo" height="50" className="mr-0 lg:mr-2" />
                        ...
                        <div className="col-12 md:col-2" style={{ marginTop: '-1.5rem' }}>
                            <Link href="/">
                                <a className="flex flex-wrap align-items-center justify-content-center md:justify-content-start md:mb-0 mb-3 cursor-pointer">
                                    <img src={`${contextPath}/layout/images/logo-dark.svg`} alt="footer sections" width="50" height="50" className="mr-2" />
