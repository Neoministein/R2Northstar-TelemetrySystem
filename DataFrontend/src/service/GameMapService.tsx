...
export class GameMapService {
    ...
    getMap(map : string) : Promise<GameMapEntity> {
        return fetch(AppConfig.apiUrl + "/map/" + map ).then(response => response.json()).then(d => d.data);
    }

    getMapScale(map : string) : Promise<GameMapScaleEntity> {
        return fetch(AppConfig.apiUrl + "/map/" + map + "/scale").then(response => response.json()).then(d => d.data);
    }
    ...
    getAllMaps() : Promise<GameMapEntity[]> {
        return fetch(AppConfig.apiUrl + "/map").then(response => response.json()).then(d => d.data.hits);
    }
}