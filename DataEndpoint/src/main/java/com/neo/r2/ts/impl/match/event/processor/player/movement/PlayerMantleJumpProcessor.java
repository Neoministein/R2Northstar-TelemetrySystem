...
@ApplicationScoped
public class PlayerMantleJumpProcessor extends AbstractBasicEventProcessor implements MatchEventProcessor {

    @Inject
    public PlayerMantleJumpProcessor(JsonSchemaLoader jsonSchemaLoader, ConfigService configService) {
